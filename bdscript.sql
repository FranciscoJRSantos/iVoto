...
ALTER TABLE mesa_voto_utilizador ADD CONSTRAINT mesa_voto_utilizador_fk1 FOREIGN KEY (mesa_voto_numero) REFERENCES mesa_voto(numero) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE mesa_voto_utilizador ADD CONSTRAINT mesa_voto_utilizador_fk2 FOREIGN KEY (eleicao_id) REFERENCES mesa_voto(eleicao_id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE mesa_voto_utilizador ADD CONSTRAINT mesa_voto_utilizador_fk3 FOREIGN KEY (utilizador_numero_cc) REFERENCES utilizador(numero_cc) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE eleicao_utilizador ADD CONSTRAINT eleicao_utilizador_fk1 FOREIGN KEY (unidade_organica_nome) REFERENCES unidade_organica_eleicao(unidade_organica_nome) ON UPDATE CASCADE ON DELETE CASCADE;
